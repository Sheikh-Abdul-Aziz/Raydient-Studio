					...
					<form className="p-6 md:p-8 w-full">
						<div className="flex flex-col gap-6">
							...
							<div className="grid grid-cols-3 gap-4">
								<Button aria-label={"Signup with Apple"} variant={"outlined"} size={"wide"} radius={"medium"}>
								...
								<Button aria-label={"Signup with Google"} variant={"outlined"} size={"wide"} radius={"medium"}>
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
										<path
								...
								<Button aria-label={"Signup with Meta"} variant={"outlined"} size={"wide"} radius={"medium"}>
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
										<path
