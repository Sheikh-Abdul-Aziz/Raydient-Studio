...
export default function Hero() {
    ...
    return (
        <div className="w-full h-auto px-4 py-8">
            <div className="flex flex-col justify-start items-center gap-y-3 mt-16">
                <HeroButton onClick={() => { }} variant="outlined" size="badge" radius="full">
                    <Layers />
                    Pioneering the Future
                </HeroButton>
                <h1 className="py-1.5 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-semibold text-start text-transparent tracking-wide bg-gradient-to-tl from-from via-via to-to bg-clip-text">
                    Elevating Brands with Minimalist Frontend <Cover>Solutions</Cover>
                </h1>
                <p className="text-sm sm:text-base md:text-base lg:text-lg font-normal text-start text-muted-foreground lg:max-w-2xl tracking-normal">
