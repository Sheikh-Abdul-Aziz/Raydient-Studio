...
const buttonVariants = cva(
    "inline-flex items-center justify-center text-center align-middle gap-x-2 whitespace-nowrap rounded-md text-sm font-normal font-label leading-normal tracking-normal ransition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
    {
        variants: {
            variant: {
            ...
            size: {
                badge: "h-7 gap-1.5 px-3 py-1 text-sm font-semibold uppercase text-foreground/80 shadow-none",
