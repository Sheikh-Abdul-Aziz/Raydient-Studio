...
const buttonVariants = cva(
    "inline-flex items-center justify-center text-center align-middle gap-x-2 whitespace-nowrap rounded-md text-sm font-normal font-accent leading-none tracking-normal transition-colors duration-200 ease-in-out focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-transparent disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
    {
        variants: {
            variant: {
            ...
            size: {
                ...
                social: "h-8 w-8 px-2 py-2 text-muted-foreground",
