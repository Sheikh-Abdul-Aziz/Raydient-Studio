...
>(function AccordionItem({ className, ...props }) {
    return (
        <AccordionPrimitive.Item
            ...
            className={cn("transition-colors duration-250 ease-in-out bg-surface hover:bg-muted/80 active:bg-muted/80 border border-border shadow-[0_0_0_rgba(0,0,0,0)] rounded-lg px-4 mb-3 last:mb-0", className)}
            {...props}
        />
    )
})
