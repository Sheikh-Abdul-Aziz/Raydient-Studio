...
const Card = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
	<div ref={ref} className={cn("relative overflow-visible rounded-lg bg-card border border-border text-card-foreground shadow-[0.5px_0.5px_1px_rgba(0,0,0,0.03)]", className)} {...props} />
))
